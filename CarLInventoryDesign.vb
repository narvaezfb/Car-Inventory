...
#End Region
    ...
    Private Sub btnEnter_Click(sender As Object, e As EventArgs) Handles btnEnter.Click
        ...
        If IsValidInput() = True Then
            ...
            If Not isCarSelected Then
                ...
                selectedCar = New Car(cmbMakes.Text, tbModel.Text, cmbYear.Text, tbPrice.Text, chBoxNew.Checked)
            ...
            ElseIf selectedCar.Id.ToString.Trim.Length > 0 Then
                ...
                selectedCar.Year = cmbYear.Text
                selectedCar.Price = tbPrice.Text
    ...
    Private Function IsValidInput() As Boolean
        ...
        If Not (Decimal.TryParse(tbPrice.Text, price) And price > 0) Then
            ...
            outputMessage = "The value entered must be numeric value greater than 0" & vbCrLf
            ' And, set the return value to false
            returnValue = False
        End If
